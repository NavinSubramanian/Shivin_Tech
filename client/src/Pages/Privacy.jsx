...
const Privacy = () => {
  return (
    <div className="termsBody">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Shivin Tech Urapakkam, 1120b, Jesudos complex, Grand Southern Trunk Rd, Senthil Nagar, Urapakkam, Guduvancheri, Tamil Nadu 603210.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
      <li>
          <p>By email: infotech@gmail.com</p>
        </li>
        <li>
          <p>By phone number: +91 93453 77563</p>
        </li>
      </ul>
    </div>
  );
